        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items">
                    <h2 class="title text-center">My Playlist</h2>
                            ...
                            <div class="col-sm-12">
                                <div class="product-image-wrapper">
                                    ...
                                    <div class="productinfo row d-flexcol-sm-9">
                                        ...
                                        <a class="btn del_st" href="/playlist/delete/<?php echo $item['id']; ?>"><i class="fa fa-times"></i></a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                        <br><a href="/" class="back"><i class="fa fa-arrow-left"></i> Back to shopping</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
